...
<body>
		...
		<table class="tabledisplay">
			...
			<tbody>
				<c:forEach items="${productlist}" var="p">
					<tr>
						<td class="tabledisplay"><img src="${cr }/pimg/${p.product_Id}.jpeg"
							height="50px"></td>
						...
						<td class="tabledisplay" class="text-center"><a
							class='btn btn-info btn-xs'
							href="${cr }/admin/getproductstoedit?productid=${p.product_Id}"><span
								class="glyphicon glyphicon-edit"></span> Edit</a> <a
							href="${cr }/admin/deleteproducts?productid=${p.product_Id}"
	...
	<div class="container">
		<c:if test="${edit}">
			<c:set var="url" value="${cr }/admin/updateproducts" />
		</c:if>
		<c:if test="${!edit}">
			<c:set var="url" value="${cr }/admin/addproducts" />
		</c:if>
		...
		<form:form action="${url} " method="post"
			...
			<p
				style="font-size: 110%; font-family: algerian; text-align: center;">
				<ins>Products</ins>
			</p>
			<c:if test="${edit}">
				<form:hidden id="product_id" placeholder="Product Id"
					name="product_id" path="product_Id" />
			</c:if>

			<label for="product_name"><b style="font-size: 100%;">Product
					Name</b></label>
			<form:input type="text" placeholder="Enter Your Name"
				id="product_name" name="product_name" path="product_Name" />
			...
			<form:textarea style="font-size:90%;height:50px;"
				id="product_description" name="product_description"
				placeholder="Write Something..." path="product_Description" />
			<form:errors path="product_Description" cssStyle="color:Red"></form:errors>
			<br>

			<label for="product_stock"><b style="font-size: 100%;">Stock</b></label>
			<form:input type="number" placeholder="Enter the Stock"
				name="product_stock" path="product_Stock" />
			<form:errors path="product_Stock" cssStyle="color:Red"></form:errors>
			<br>

			<label for="product_price"><b style="font-size: 100%;">Price</b></label>
			<form:input type="number" step="any" placeholder="Enter Price"
				id="product_price" name="product_price" path="product_Price" />
			<form:errors path="product_Price" cssStyle="color:Red"></form:errors>
			<br>

			<label for="category_name"><b style="font-size: 100%;">Category
					Name</b></label>
			<br>
			<form:select id="category_name" name="category_name"
