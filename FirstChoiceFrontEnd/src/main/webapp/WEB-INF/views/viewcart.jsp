...
<div class="container">
		<p
			...
			<div class="row">
			                   <div class="col-6">
									<a href="${cr }/home" style="float: left;width:190px;" class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i>  Save for Later</a>
								</div>
								<div class="col-6">
									<a href="${cr }/user/selectaddress" style="float: right;width:190px;" class="btn btn-success">Place Order <i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
								</div>								
		</div>
		<hr style="border:double;">
